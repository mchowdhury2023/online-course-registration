const Registration = ({ selectedCourses, totalCredits, totalPrice, remainingCredit }) => {
  return (
    <div className='w-1/4 ml-5 mr-5'>
      <div className="bg-white p-6 border-2 border-gray-200 rounded-lg shadow-md">
      <p className="text-lg mb-2"><strong>Remaining total hours: {remainingCredit}</strong></p>
